...
<%@ include file="/WEB-INF/view/template/header.jsp" %>
	...
	<div class="modal">
		...
		<table width="600" class="table table-bordered table-hover">
	        ...
	        <a href="" onclick="window.open('${pageContext.request.contextPath}/data/mail/send?nick=${info.name}', '쪽지보내기', 'width=800, height=500'); return false;">쪽지보내기</a> iv        	ight" align="right">
